...
const ShippingPolicy = () => {
  const data = {
    ...
    url: 'https://www.xsnapster.store/shipping-policy'
  }
  return (
    <>
          ...
          >
            ...
            >
              ...
              <p className='text-[16px] leading-relaxed text-justify'>
                Once you hit <b className='text-red-500'>"Place Order"</b>, your
                aesthetic upgrade begins. We print, pack, and ship your frames
                with more care than your ex ever showed you. This page explains
                how your order travels from our lair to your wall.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className='text-[16px] leading-relaxed text-justify'>
                ...
                package leaves our warehouse, it's officially in transit — aka
                the "long-distance relationship" phase.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className='text-[16px] mb-3 text-justify'>
                We ship all across India through trusted delivery partners.
              ...
              <ul className='list-disc ml-5 text-[16px] leading-relaxed'>
                ...
                <li>
                  <b>Remote Locations:</b> Depends on whether Google Maps can
                  find you.
                </li>
              </ul>
              <p className='text-[16px] mt-3 text-justify'>
                You'll get a tracking link once your order ships, so you can
                stalk it guilt-free.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className='text-[16px] text-justify'>
                ...
                your delivery is delayed, we'll keep you updated. We hate
                ghosting more than you do.
              </p>
            </motion.div>
            ...
            >
              ...
              <hr className='mb-4 border-gray-200' />
              <p className='text-[16px] text-justify'>
                You'll receive a tracking ID via email once your order ships.
                Use it to see where your frame is — or just pretend you're
                watching a slow-burn thriller. If tracking shows "Delivered" but
                you're still waiting, check with neighbours, guards, or that one
                cousin who borrows things permanently.
              </p>
            </motion.div>
            ...
            >
              ...
              <ul className='list-disc ml-5 text-[16px] leading-relaxed'>
                <li>
                  Make sure your shipping address is correct before checkout.
                  Once it's shipped, not even Sherlock can reroute it.
                </li>
                <li>
                  If the courier couldn't reach you, your order may be sent
                  back. Don't worry — we'll contact you before reshipping.
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <hr className='mb-4 border-gray-200' />
              <p className='text-[16px] text-justify'>
                We pack every frame like it's our first crush — safe, secure,
                and a little dramatic. If anything goes wrong, we'll fix it
                faster than your internet provider responds to complaints. For
                any delivery-related emergencies, drop us a line at{' '}
                <a
