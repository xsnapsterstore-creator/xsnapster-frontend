...
import { setUserDetails } from "@/components/store/cartSlice";
...
const AdminIndex = () => {
  ...
  const handleSendOTP = async () => {
    ...
    // const res = await requestOTP(email); // Here will be our Admin API
  ...
  const handleVerifyOTP = async () => {
    ...
    // const res = await verifyOTP(email, otp); //Here will be our Admin Verify OTP API
    // const data = await res.json();
