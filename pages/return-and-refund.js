        ...
        <div className='max-w-3xl mx-auto px-8 flex flex-col gap-12'>
          ...
          >
            ...
            <ul className='list-disc ml-6 text-gray-700 leading-relaxed space-y-2'>
              <li>
                Your frame arrived damaged, scratched, or not-so-aesthetic.
              </li>
              <li>
          ...
          >
            ...
            <ol className='list-decimal ml-6 text-gray-700 leading-relaxed space-y-2'>
              ...
              <li>
                Attach clear pictures of the issue (no filters, please — we
                trust you).
              </li>
              <li>
            ...
            <p className='text-gray-600 mt-3 italic'>
              Once approved, we'll guide you through the return or refund
              process faster than your crush ghosts you.
            </p>
          </motion.section>
          ...
          >
            ...
            <p className='text-gray-600 mt-3 italic'>
              If your bank moves slower than your Wi-Fi, give it a few more
              days.
            </p>
          </motion.section>
          ...
          >
            ...
            <p className='text-gray-600 mb-3'>
              Here's what we can't take back:
            </p>
            <ul className='list-disc ml-6 text-gray-700 leading-relaxed space-y-2'>
