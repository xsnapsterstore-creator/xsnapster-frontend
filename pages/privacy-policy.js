...
const PrivacyPolicy = () => {
  const data = {
    title:
      'Privacy Policy: Your Data Stays Private (Unlike Your Search History) | XSNAPSTER',
    desc: 'Privacy is sexy when done right. At XSNAPSTER, we protect your data like we protect our sarcasm—no leaks, no creeps, and no shady business. Read our "No Drama" Privacy Policy.',
    keyword:
      'XSNAPSTER privacy policy, secure checkout, data protection, secure shopping, photo frame website privacy, privacy, secure payment frames.',
    url: 'https://www.xsnapster.store/privacy-policy'
  }
  ...
  return (
    <>
      ...
      <div className='pt-[120px] pb-16 px-6 md:px-24 bg-gradient-to-b from-[#F2F2F2] via-[#F2F2F2]/60 text-black relative overflow-hidden'>
        {/* Glowing Blobs */}
