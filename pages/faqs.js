...
const Faqs = () => {
  ...
  const data = {
    title: 'Your Burning Questions Answered | XSNAPSTER',
    desc: 'Got questions? We have got answers (and zero chill). Find out why XSNAPSTER is the only X site your walls need. From shipping speeds to our OnlyFrames policy, get the tea here.',
    keyword:
      'XSNAPSTER FAQ, premium photo frames, aesthetic wall decor, premium posters, custom frames, home decor, bold art prints',
    url: 'https://www.xsnapster.store/faqs'
  }
  return (
    <>
      ...
      <div className='pt-[110px] pb-20 px-6 lg:px-20 bg-gradient-to-b from-[#F2F2F2] via-[#F2F2F2]/60 min-h-screen'>
        ...
        >
          ...
          <p className='text-gray-600 mt-2 text-sm'>
            Here's everything you didn't know you needed to ask.
          </p>
