...
const HelpCenter = () => {
  const data = {
    title: 'Help & Support: For People Who Hate Boring Walls | XSNAPSTER',
    desc: 'Lost? Confused? Relax. The XSNAPSTER Help Center is here to fix your "WTF moments." From order tracking to custom frames, get the answers you need without the drama.',
    keyword:
      'XSNAPSTER support, custom photo frames, track my order, wall decor help, FAQ, premium posters shipping, refund policy, XSNAPSTER contact email.',
    url: 'https://www.xsnapster.store/help-center'
  }
  return (
    <>
      <StaticPageSEO data={data} />
      <div className='pt-[120px] pb-20 bg-gradient-to-b from-[#F2F2F2] via-[#F2F2F2]/60 min-h-screen'>
          ...
          >
            ...
            >
              ...
              <p className='text-[16px] leading-relaxed text-justify text-gray-700'>
                ...
                Help Center, a safe space where your "WTF moments" meet their
                happy endings. We've broken things down so even your goldfish
                could understand (no offense).
              </p>
            </motion.div>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-[16px] text-gray-700 text-justify'>
                    ...
                    glow up,” congrats — it's official! No email? Check your
                    spam folder before accusing us of ghosting.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className='text-[16px] text-gray-700 text-justify'>
                    Usually 3–7 business days, depending on how lazy your
                    delivery guy is. Don't worry — we'll send a tracking link so
                    you can stalk your frame guilt-free.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-[16px] text-gray-700 text-justify'>
                    All major Cards, UPI, and Wallets. No goats, no barter
                    deals.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className='text-[16px] text-gray-700 text-justify'>
                    If your frame arrives broken or looking like abstract art
                    (and not in a good way), contact us within 7 days. We'll fix
                    it faster than you can say “refund me.”
                  </p>
                </div>
            ...
            >
              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <p className='text-[16px] text-gray-700 text-justify'>
                    Yes, all our frames are wall-ready. No tools, no drama —
                    just hang it and admire your life choices.
                  </p>
                </div>
            ...
            >
              ...
              <hr className='mb-4 border-gray-200' />
              <p className='text-[16px] text-gray-700 text-justify'>
                We might joke a lot, but we take customer happiness seriously.
                If something's wrong, we'll fix it — no drama, no excuses, just
                pure frame redemption.
              </p>
            </motion.div>
          </motion.div>
        </div>
